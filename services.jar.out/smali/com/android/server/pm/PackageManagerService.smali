...
.field static final DEBUG_SD_INSTALL:Z = true
...
.field private static final MSG_POP_PERMISSION:I = 0x75
...
.field static final mAssertEnalbe:Z = false
...
.field static mSdcardApkInstalled:Z = false
...
.field private mPopPermissionHandler:Landroid/os/Handler;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/PackageManagerService;->mAssertEnalbe:Z
    ...
    .line 8667
    sput-boolean v3, Lcom/android/server/pm/PackageManagerService;->mSdcardApkInstalled:Z
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mPopPermissionHandler:Landroid/os/Handler;
    ...
    .line 925
    .local v36, separateProcesses:Ljava/lang/String;
    if-eqz v36, :cond_7
    ...
    iget-object v3, v3, Lcom/android/server/pm/Settings;->mSettingsFilename:Ljava/io/File;

    invoke-virtual {v2, v3}, Lcom/android/server/pm/Settings;->parsePackagesXml(Ljava/io/File;)Z
    ...
    iget-object v2, v2, Lcom/android/server/pm/Settings;->mSettingsFilename:Ljava/io/File;
    ...
    iget-object v3, v3, Lcom/android/server/pm/Settings;->mBackupSettingsFilename:Ljava/io/File;
    ...
    iget-object v2, v2, Lcom/android/server/pm/Settings;->mBackupSettingsFilename:Ljava/io/File;
    ...
    .line 990
    .local v25, libFiles:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    new-instance v2, Ljava/io/File;
    ...
    .line 1000
    .local v10, bootClassPath:Ljava/lang/String;
    if-eqz v10, :cond_8

    .line 1001
    const/16 v2, 0x3a

    invoke-static {v10, v2}, Lcom/android/server/pm/PackageManagerService;->splitString(Ljava/lang/String;C)[Ljava/lang/String;

    move-result-object v31

    .line 1002
    .local v31, paths:[Ljava/lang/String;
    const/16 v21, 0x0
    ...
    .line 233
    .end local v10           #bootClassPath:Ljava/lang/String;
    .end local v11           #d:Landroid/view/Display;
    .end local v12           #dataDir:Ljava/io/File;
    .end local v15           #didDexOpt:Z
    .end local v21           #i:I
    .end local v25           #libFiles:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v31           #paths:[Ljava/lang/String;
    .end local v35           #scanMode:I
    .end local v36           #separateProcesses:Ljava/lang/String;
    .end local v37           #startTime:J
    .end local v39           #wm:Landroid/view/WindowManager;
    :cond_5
    ...
    .line 931
    .restart local v36       #separateProcesses:Ljava/lang/String;
    :cond_6
    const/4 v2, 0x0
    ...
    .line 1009
    .restart local v10       #bootClassPath:Ljava/lang/String;
    .restart local v11       #d:Landroid/view/Display;
    .restart local v12       #dataDir:Ljava/io/File;
    .restart local v15       #didDexOpt:Z
    .restart local v21       #i:I
    .restart local v25       #libFiles:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v31       #paths:[Ljava/lang/String;
    .restart local v35       #scanMode:I
    .restart local v37       #startTime:J
    .restart local v39       #wm:Landroid/view/WindowManager;
    :catch_0
    move-exception v16
    ...
    .line 1025
    .local v27, libs:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_a
    :goto_4
    ...
    .end local v27           #libs:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_b
    ...
    .line 1055
    .local v26, libPath:Ljava/io/File;
    ...
    .end local v16           #e:Ljava/io/IOException;
    .end local v21           #i:I
    .end local v26           #libPath:Ljava/io/File;
    ...
    invoke-static {v2, v3}, Landroid/content/pm/PackageParser;->parsePackageLite(Ljava/lang/String;I)Landroid/content/pm/PackageParser$PackageLite;

    move-result-object v32

    .line 1156
    .local v32, pkg:Landroid/content/pm/PackageParser$PackageLite;
    if-nez v32, :cond_14
    ...
    .end local v22           #i$:I
    .end local v23           #len$:I
    .end local v32           #pkg:Landroid/content/pm/PackageParser$PackageLite;
    :cond_13
    move-object/from16 v0, p0
    ...
    .line 1187
    .local v13, deletePkgsList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/pm/PackageSetting;>;"
    const/16 v21, 0x0
    ...
    .line 1160
    .end local v13           #deletePkgsList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/pm/PackageSetting;>;"
    .end local v21           #i:I
    ...
    .restart local v32       #pkg:Landroid/content/pm/PackageParser$PackageLite;
    :cond_14
    move-object/from16 v0, p0
    ...
    const-string v4, "this apk has been installed:"
    ...
    iget-object v4, v0, Landroid/content/pm/PackageParser$PackageLite;->packageName:Ljava/lang/String;
    ...
    const-string v4, "this apk has not been installed:"
    ...
    .line 1171
    :cond_16
    invoke-static {v8, v14}, Landroid/os/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    const-string v3, "copy apk error!!!!!!!!!!"
    ...
    .end local v23           #len$:I
    .end local v32           #pkg:Landroid/content/pm/PackageParser$PackageLite;
    .restart local v13       #deletePkgsList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/pm/PackageSetting;>;"
    .restart local v21       #i:I
    :cond_17
    ...
    .line 1217
    .local v34, psit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/server/pm/PackageSetting;>;"
    :cond_18
    :goto_c
    ...
    .end local v34           #psit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/server/pm/PackageSetting;>;"
    :cond_19
    const/4 v2, 0x0
...
.method static synthetic access$2900(Lcom/android/server/pm/PackageManagerService;)Z
    .locals 1
    .parameter "x0"
...
.method private deletePackageX(Ljava/lang/String;ZZI)I
    ...
    .line 7135
    invoke-direct {p0, p1, v6}, Lcom/android/server/pm/PackageManagerService;->removeActiveAdmin(Ljava/lang/String;Landroid/app/admin/IDevicePolicyManager;)V
    :try_end_0
...
.method private loadMediaPackages(Ljava/util/HashMap;[ILjava/util/HashSet;)V
    ...
    .line 8512
    .local v23, beginLoad:J
    new-instance v32, Ljava/util/ArrayList;

    invoke-direct/range {v32 .. v32}, Ljava/util/ArrayList;-><init>()V

    .line 8513
    .local v32, pkgList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    invoke-virtual/range {p1 .. p1}, Ljava/util/HashMap;->keySet()Ljava/util/Set;

    move-result-object v30

    .line 8514
    .local v30, keys:Ljava/util/Set;,"Ljava/util/Set<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;>;"
    const/16 v27, 0x0
    ...
    check-cast v22, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;

    .line 8516
    .local v22, args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    move-object/from16 v0, p1
    ...
    .line 8518
    .local v26, codePath:Ljava/lang/String;
    const-string v3, "PackageManager"
    ...
    iget-object v6, v0, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->cid:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->doPreInstall(I)I
    ...
    const-string v6, " when installing from sdcard. i = "
    ...
    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->cid:Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getCodePath()Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->doPostInstall(I)I
    ...
    .line 8593
    :cond_6
    sget-boolean v3, Lcom/android/server/pm/PackageManagerService;->mAssertEnalbe:Z
    ...
    const-string v4, "sleep 100 when install sdcard apk!"
    ...
    iget-object v4, v0, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->cid:Ljava/lang/String;
    ...
    .line 8600
    .end local v5           #parseFlags:I
    .end local v22           #args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    .end local v26           #codePath:Ljava/lang/String;
    .end local v28           #i:I
    .end local v31           #pkg:Landroid/content/pm/PackageParser$Package;
    .end local v33           #retCode:I
    .end local v34           #retPreInstall:Z
    :cond_9
    const-string v3, "PackageManager"
    ...
    const-string v6, "Time to load sdcard packages: "
    ...
    iget-boolean v3, v0, Lcom/android/server/pm/PackageManagerService;->mSystemReady:Z
    ...
    const-string v3, "com.oppo.android.pm.EXTERNAL_PACKAGES_LOAD_OK"

    invoke-direct {v13, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 8635
    .local v13, intent:Landroid/content/Intent;
    const-string v3, "com.oppo.android.pm.EXTERNAL_PACKAGES_SUM"
    ...
    invoke-interface/range {v11 .. v21}, Landroid/app/IActivityManager;->broadcastIntent(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ZZ)I
    :try_end_b
    ...
    .line 8656
    invoke-static/range {v25 .. v25}, Lcom/android/internal/content/PackageHelper;->destroySdDir(Ljava/lang/String;)Z
    ...
    .restart local v25       #cid:Ljava/lang/String;
    :cond_f
    const-string v3, "PackageManager"
...
.method private removeActiveAdmin(Ljava/lang/String;Landroid/app/admin/IDevicePolicyManager;)V
    .locals 10
    .parameter "packageName"
    .parameter "dpm"
    ...
    const-string v9, "removeActiveAdmin package which has active device admin. packageName = "
    ...
    .line 7081
    .local v5, resolveType:Ljava/lang/String;
    const/16 v7, 0x80

    invoke-virtual {p0, v4, v5, v7}, Lcom/android/server/pm/PackageManagerService;->queryIntentReceivers(Landroid/content/Intent;Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {v1, p1, v7}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v9, "ri.activityInfo.name == "
    ...
    .line 7094
    :try_start_1
    invoke-interface {p2, v1}, Landroid/app/admin/IDevicePolicyManager;->removeActiveAdmin(Landroid/content/ComponentName;)V
    :try_end_1
...
.method private scanPackageLI(Landroid/content/pm/PackageParser$Package;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    iput v10, v3, Landroid/content/pm/ActivityInfo;->configChanges:I
    ...
    invoke-static {v0, v3}, Lcom/android/server/pm/ApkHelper;->needUnpackLibrary(Ljava/lang/String;Z)Z
...
.method private unloadMediaPackages(Ljava/util/HashMap;[IZ)V
    ...
    .line 8702
    .local v20, beginUnload:J
    const-string v3, "PackageManager"

    const-string v5, "unloading media packages"
    ...
    .line 8704
    .local v26, pkgList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v22, Ljava/util/ArrayList;

    invoke-direct/range {v22 .. v22}, Ljava/util/ArrayList;-><init>()V

    .line 8705
    .local v22, failedList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;>;"
    invoke-virtual/range {p1 .. p1}, Ljava/util/HashMap;->keySet()Ljava/util/Set;

    move-result-object v24

    .line 8706
    .local v24, keys:Ljava/util/Set;,"Ljava/util/Set<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;>;"
    ...
    check-cast v19, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;

    .line 8707
    .local v19, args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getPackageName()Ljava/lang/String;
    ...
    const-string v6, "Trying to unload pkg : "
    ...
    const-string v5, "sleep 100 when uninstall sdcard apk!"
    ...
    const-string v6, "Failed to delete pkg from sdcard : "
    ...
    .end local v19           #args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    :cond_2
    move-object/from16 v0, p0
    ...
    const-string v6, "Time to unload sdcard packages: "
    ...
    new-instance v5, Lcom/android/server/pm/PackageManagerService$13;
    ...
    invoke-direct {v5, v0, v1, v2}, Lcom/android/server/pm/PackageManagerService$13;-><init>(Lcom/android/server/pm/PackageManagerService;ZLjava/util/Set;)V
    ...
    invoke-direct {v0, v3, v1, v2, v5}, Lcom/android/server/pm/PackageManagerService;->sendResourcesChangedBroadcast(ZLjava/util/ArrayList;[ILandroid/content/IIntentReceiver;)V
    ...
    const-string v3, "com.oppo.android.pm.EXTERNAL_PACKAGES_UNLOAD_OK"
    ...
    invoke-interface/range {v8 .. v18}, Landroid/app/IActivityManager;->broadcastIntent(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ZZ)I
    :try_end_3
    ...
    iget-object v5, v0, Lcom/android/server/pm/PackageManagerService;->mHandler:Lcom/android/server/pm/PackageManagerService$PackageHandler;
    ...
    invoke-virtual {v5, v6, v3, v9, v0}, Lcom/android/server/pm/PackageManagerService$PackageHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private updateExternalMediaStatusInner(ZZ)V
    ...
    .line 8399
    .local v19, removeCids:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    new-instance v17, Ljava/util/HashMap;

    invoke-direct/range {v17 .. v17}, Ljava/util/HashMap;-><init>()V

    .line 8401
    .local v17, processCids:Ljava/util/HashMap;,"Ljava/util/HashMap<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;Ljava/lang/String;>;"
    invoke-static {}, Lcom/android/internal/content/PackageHelper;->getSecureContainerList()[Ljava/lang/String;
    ...
    const-string v24, "No secure containers on sdcard"
    ...
    const-string v24, "Loading packages"
    ...
    new-instance v4, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;

    move-object/from16 v0, p0

    invoke-direct {v4, v0, v6}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;-><init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)V

    .line 8418
    .local v4, args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    const-string v23, "PackageManager"
    ...
    const-string v26, "Processing container "
    ...
    .line 8419
    invoke-virtual {v4}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getPackageName()Ljava/lang/String;
    ...
    const-string v26, "Looking for pkg : "
    ...
    invoke-virtual {v4}, Lcom/android/server/pm/PackageManagerService$SdInstallArgs;->getCodePath()Ljava/lang/String;
    ...
    const-string v26, " corresponds to pkg : "
    ...
    .line 8450
    .end local v4           #args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    ...
    const-string v25, "Failed to update status of external media."
    ...
    .line 8445
    .end local v14           #num:I
    .restart local v4       #args:Lcom/android/server/pm/PackageManagerService$SdInstallArgs;
    .restart local v6       #cid:Ljava/lang/String;
    .restart local v11       #i$:I
    .restart local v12       #len$:I
    .restart local v15       #num:I
    .restart local v16       #pkgName:Ljava/lang/String;
    .restart local v18       #ps:Lcom/android/server/pm/PackageSetting;
    :cond_4
    :try_start_4
    const-string v23, "PackageManager"
    ...
    invoke-static {v0, v1, v15}, Ljava/util/Arrays;->sort([III)V
    ...
    const-string v24, "Unloading packages"
...
.method public checkPermission(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v4, v4, Lcom/android/server/pm/GrantedPermissions;->disabledPermissions:Ljava/util/HashSet;
    ...
    iget-object v4, v1, Lcom/android/server/pm/GrantedPermissions;->disabledPermissions:Ljava/util/HashSet;
...
.method public checkUidPermission(Ljava/lang/String;I)I
    ...
    invoke-virtual {v9, p2}, Lcom/android/server/pm/Settings;->getUserIdLPr(I)Ljava/lang/Object;
    ...
    iget-object v9, v1, Lcom/android/server/pm/GrantedPermissions;->disabledPermissions:Ljava/util/HashSet;
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService;->mPopPermissionHandler:Landroid/os/Handler;
    ...
    .line 1988
    .restart local v1       #gp:Lcom/android/server/pm/GrantedPermissions;
    :cond_0
    iget-object v9, v1, Lcom/android/server/pm/GrantedPermissions;->grantedPermissions:Ljava/util/HashSet;
...
.method public deletePackage(Ljava/lang/String;Landroid/content/pm/IPackageDeleteObserver;I)V
    ...
    .line 7049
    .local v1, vendingUid:I
    if-ne v0, v1, :cond_0

    .line 7050
    const-string v2, "PackageManager"

    const-string v3, "specially handle for com.android.vending!!!"
    ...
    invoke-direct {v3, p0, p1, p3, p2}, Lcom/android/server/pm/PackageManagerService$8;-><init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ILandroid/content/pm/IPackageDeleteObserver;)V
...
.method public dosSdcardApkInstalled()Z
    .locals 1

    .prologue
    .line 8670
    sget-boolean v0, Lcom/android/server/pm/PackageManagerService;->mSdcardApkInstalled:Z
...
.method public getApplicationInfoForRes(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    .locals 7
    .parameter "resDir"
    .parameter "uid"
    ...
    .line 9050
    .local v3, packages:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/content/pm/PackageParser$Package;>;"
    invoke-interface {v3}, Ljava/util/Collection;->iterator()Ljava/util/Iterator;

    move-result-object v1

    .line 9051
    .local v1, it:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/pm/PackageParser$Package;>;"
    :cond_0
    if-eqz v1, :cond_2
    ...
    invoke-static {v2, v5}, Landroid/content/pm/PackageParser;->generateApplicationInfo(Landroid/content/pm/PackageParser$Package;I)Landroid/content/pm/ApplicationInfo;
    ...
    .line 9059
    .end local v1           #it:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/pm/PackageParser$Package;>;"
    .end local v3           #packages:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/content/pm/PackageParser$Package;>;"
    :catchall_0
    move-exception v5
...
.method public getDisabledPermissions(Ljava/lang/String;)Ljava/util/List;
    .locals 10
    .parameter "packageName"
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 9132
    .local v4, pkgPermessions:Lcom/android/server/pm/GrantedPermissions;
    const/4 v2, 0x0

    .line 9133
    .local v2, packageSharedUser:Lcom/android/server/pm/SharedUserSetting;
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService;->mSettings:Lcom/android/server/pm/Settings;
    ...
    iget-object v7, v5, Lcom/android/server/pm/PackageSettingBase;->realName:Ljava/lang/String;
    ...
    .line 9139
    iget-object v2, v5, Lcom/android/server/pm/PackageSetting;->sharedUser:Lcom/android/server/pm/SharedUserSetting;
    ...
    const-string v9, " has sharedUserId="
    ...
    iget-object v7, v7, Lcom/android/server/pm/Settings;->mSharedUsers:Ljava/util/HashMap;
    ...
    const-string v9, " has not been installed!!!"
    ...
    .line 9160
    .local v0, disabledPermissions:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    iget-object v7, v4, Lcom/android/server/pm/GrantedPermissions;->disabledPermissions:Ljava/util/HashSet;
    ...
    const-string v9, "add disabledPermission:"
...
.method public installPackageWithVerification(Landroid/net/Uri;Landroid/content/pm/IPackageInstallObserver;ILjava/lang/String;Landroid/net/Uri;Landroid/content/pm/ManifestDigest;)V
    ...
    .line 5065
    .local v11, callingId:I
    const-string v1, "com.android.vending"

    move-object/from16 v0, p0

    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;)I

    move-result v18

    .line 5066
    .local v18, vendingUid:I
    move/from16 v0, v18
    ...
    const-string v2, "specially handle for com.android.vending!!!"
    ...
    .line 5079
    .local v9, INVLAID_IMEI:Ljava/lang/String;
    const-string v10, "persist.sys.oppo.device.imei"

    .line 5080
    .local v10, PERSIST_KEY:Ljava/lang/String;
    ...
    invoke-static {v10, v13}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 5091
    .end local v9           #INVLAID_IMEI:Ljava/lang/String;
    .end local v10           #PERSIST_KEY:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/android/server/pm/PackageManagerService$InstallParams;-><init>(Lcom/android/server/pm/PackageManagerService;Landroid/net/Uri;Landroid/content/pm/IPackageInstallObserver;ILjava/lang/String;Landroid/net/Uri;Landroid/content/pm/ManifestDigest;)V
    ...
    invoke-virtual {v1, v14}, Lcom/android/server/pm/PackageManagerService$PackageHandler;->sendMessage(Landroid/os/Message;)Z

    .line 5108
    return-void

    .line 5072
    .end local v5           #filteredFlags:I
    ...
    :cond_4
    and-int/lit8 v5, p3, -0x21

    .restart local v5       #filteredFlags:I
    goto :goto_1
.end method
...
.method public modifyPermissions(Ljava/lang/String;Ljava/util/List;Z)V
    .locals 8
    .parameter "packageName"
    .parameter
    .parameter "disable"
    ...
    .line 9077
    .local v3, pkgPermessions:Lcom/android/server/pm/GrantedPermissions;
    const/4 v1, 0x0

    .line 9078
    .local v1, packageSharedUser:Lcom/android/server/pm/SharedUserSetting;
    iget-object v6, p0, Lcom/android/server/pm/PackageManagerService;->mSettings:Lcom/android/server/pm/Settings;
    ...
    iget-object v6, v4, Lcom/android/server/pm/PackageSettingBase;->realName:Ljava/lang/String;
    ...
    iget-object v6, v4, Lcom/android/server/pm/PackageSettingBase;->name:Ljava/lang/String;
    ...
    iget-object v6, v6, Lcom/android/server/pm/Settings;->mSharedUsers:Ljava/util/HashMap;
    ...
    .line 9098
    .end local v5           #su:Lcom/android/server/pm/SharedUserSetting;
    :cond_6
    if-nez v3, :cond_7
    ...
    .end local v1           #packageSharedUser:Lcom/android/server/pm/SharedUserSetting;
    .end local v3           #pkgPermessions:Lcom/android/server/pm/GrantedPermissions;
    :catchall_0
    move-exception v6
    ...
    .restart local v1       #packageSharedUser:Lcom/android/server/pm/SharedUserSetting;
    .restart local v3       #pkgPermessions:Lcom/android/server/pm/GrantedPermissions;
    :cond_7
    :try_start_1
    ...
    .line 9110
    iget-object v6, v3, Lcom/android/server/pm/GrantedPermissions;->disabledPermissions:Ljava/util/HashSet;
...
.method public updateExternalMediaStatus(ZZ)V
    ...
    const-string v5, "updateExternalMediaStatus:: mediaStatus="
    ...
    const-string v5, ", mMediaMounted="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/server/pm/PackageManagerService;->mMediaMounted:Z
