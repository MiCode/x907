...
.method private computeStatsDelta(Landroid/net/NetworkStats;Landroid/net/NetworkStats;ZLjava/lang/String;)Landroid/net/NetworkStats;
    ...
    invoke-virtual {p2}, Landroid/net/NetworkStats;->getElapsedRealtime()J
    ...
    .end local p2
    invoke-direct {p2, v8, v9, v7}, Landroid/net/NetworkStats;-><init>(JI)V
...
.method private static readNetworkStats(Lcom/android/internal/os/AtomicFile;Ljava/util/HashMap;)V
    ...
    .line 1177
    invoke-virtual {p0}, Lcom/android/internal/os/AtomicFile;->getBaseFile()Ljava/io/File;
    ...
    .end local v6           #inFile:Ljava/io/File;
    :catchall_0
    move-exception v10
...
.method private readUidStatsLocked()V
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/os/AtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/os/AtomicFile;->getBaseFile()Ljava/io/File;

    move-result-object v16

    .line 1260
    .local v16, uidFile:Ljava/io/File;
    if-eqz v16, :cond_1
    ...
    const-string v19, "problem reading uid stats()"
    ...
    .end local v16           #uidFile:Ljava/io/File;
    :catchall_0
    move-exception v18
