...
.field private static final HDMI_EVT_CAM_ON_PREV:Ljava/lang/String; = "cam_on_prev"
...
.field private static final HDMI_EVT_MHL_IN_USE_BEFORE:Ljava/lang/String; = "mhl_in_use_before"

.field private static final HDMI_EVT_MHL_STATE_ON:Ljava/lang/String; = "mhl_state_on"
...
.field private static final HDmI_CMD_HDCPOPTION:Ljava/lang/String; = "hdmi_hdcp: "
...
.method private handleEvent(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lcom/android/server/HDMIService;->notifyCamAndHDMIcollision()V

    goto :goto_2

    .line 114
    :cond_6
    const-string v3, "mhl_state_on"
    ...
    invoke-virtual {v3}, Lcom/android/server/HDMIService;->notifyMHLStateOn()V

    goto :goto_2

    .line 118
    :cond_7
    const-string v3, "mhl_in_use_before"
    ...
    invoke-virtual {v3}, Lcom/android/server/HDMIService;->notifyMHLInUseBeforeCamera()V
...
.method public setHDCP(Z)V
    .locals 3
    .parameter "hdcpOption"
