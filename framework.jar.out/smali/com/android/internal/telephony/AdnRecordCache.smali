...
.method private oppoReviseEfIdForUsim(I)I
    ...
    .prologue
    .line 578
    iget-boolean v0, p0, Lcom/android/internal/telephony/AdnRecordCache;->isUim:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v8, "adn load ok,save adnlikefile efid:"
    ...
    iget-boolean v6, p0, Lcom/android/internal/telephony/AdnRecordCache;->isUim:Z

    if-nez v6, :cond_2

    iget v6, v0, Lcom/android/internal/telephony/AdnRecord;->recordNumber:I

    if-gtz v6, :cond_2

    .line 365
    iput v3, v0, Lcom/android/internal/telephony/AdnRecord;->recordNumber:I
...
.method public oppoGetADNFieldsInfo(ILandroid/os/Message;)V
    ...
    .line 560
    iget-boolean v1, p0, Lcom/android/internal/telephony/AdnRecordCache;->isUim:Z
    ...
    invoke-virtual {v1, p1, p2, v0}, Lcom/android/internal/telephony/AdnRecordLoader;->oppoGetADNFieldsInfo(ILandroid/os/Message;I)V
...
.method public oppoUpdateAdnByIndex(IILcom/android/internal/telephony/AdnRecord;ILjava/lang/String;Landroid/os/Message;)V
    .locals 9
    .parameter "efid"
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->oppoUpdateAdn(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;ILjava/lang/String;Landroid/os/Message;)I
    ...
    invoke-virtual {p0, v1, p1, p4, p3}, Lcom/android/internal/telephony/AdnRecordCache;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public oppoUpdateAdnBySearch(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;Ljava/lang/String;Landroid/os/Message;)I
    .locals 12
    .parameter "efid"
    .parameter "oldAdn"
    .parameter "newAdn"
    ...
    const-string v2, "enter oppoUpdateAdnBySearch =====wjp debug"
    ...
    const-string v2, "call mUsimPhoneBookManager.oppoUpdateAdn =====wjp debug"
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->oppoUpdateAdn(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;ILjava/lang/String;Landroid/os/Message;)I
    ...
    const-string v2, "call mUsimPhoneBookManager.oppoUpdateAdn fail=====wjp debug"
    ...
    const-string v2, "EF is not known ADN-like =====wjp debug"
    ...
    const-string v2, "Adn list not exist =====wjp debug"
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/AdnCacheManager;->handleNonExistentAdnRecord(I)V
    ...
    const-string v2, "Adn record don\'t exist =====wjp debug"
    ...
    const-string v2, "Have pending update for EF=====wjp debug"
    ...
    const-string v2, "call AdnRecordLoader(mFh).updateEF =====wjp debug"
    ...
    const-string v2, "call AdnRecordLoader(mFh).updateEF return index -1=====wjp debug"
...
.method public requestLoadAllAdnLike(IILandroid/os/Message;)V
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/AdnRecordCache;->isUim:Z
    ...
    invoke-virtual {p0, v4, p1, v3}, Lcom/android/internal/telephony/AdnRecordCache;->obtainMessage(III)Landroid/os/Message;
...
.method public reset()V
    ...
    const-string v1, "adnrecordcache reset,will clear the adnLikeFiles "
