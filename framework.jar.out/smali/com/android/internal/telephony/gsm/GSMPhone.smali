...
.method private oppoNotifyNewSimInserted()V
    .locals 2
    ...
    const-string/jumbo v1, "oppoNotifyNewSimInserted..."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1972
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mOppoMmiNewSimRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/PhoneNotifier;->notifySimCardState(I)V

    .line 1975
    return-void
.end method

.method private oppoSimRecordsLoaded()V
    .locals 2
    ...
    const-string/jumbo v1, "oppoSimRecordsLoaded..."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1959
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mOppoMmiSimRecordsRegistrants:Landroid/os/RegistrantList;

    invoke-virtual {v0}, Landroid/os/RegistrantList;->notifyRegistrants()V

    .line 1962
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mOppoSimPhoneBookReadyRegistrant:Landroid/os/RegistrantList;

    invoke-virtual {v0}, Landroid/os/RegistrantList;->notifyRegistrants()V

    .line 1963
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mOppoSimSmsReadyRegistrant:Landroid/os/RegistrantList;
...
.method public changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v1, "changeBarringPassword()"
...
.method public emDial(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "mCM.oppoGetEMMode() = "
...
.method public getDataConnectionState(Ljava/lang/String;)Lcom/android/internal/telephony/Phone$DataState;
    ...
    .line 350
    const-string v1, "getDataConnectionState: msst=null"
    ...
    .line 363
    const-string v1, "getDataConnectionState: ApnTypeDisabled or not active"
    ...
    const-string v2, "getDataConnectionState: state="
...
.method public getFacilityLock(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "queryFacilityLock()"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1317
    :sswitch_1
    const-string/jumbo v19, "ro.config.multimode_cdma"
    ...
    invoke-interface/range {v19 .. v20}, Lcom/android/internal/telephony/CommandsInterface;->getCDMASubscription(Landroid/os/Message;)V
    ...
    const-string v19, "android.security.SIM_RECORDS_LOADED"
    ...
    .line 1357
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->oppoNotifyNewSimInserted()V

    .line 1359
    :cond_2
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->oppoSimRecordsLoaded()V
    ...
    const-string v20, "GSMPhone nofity PhoneApp EVENT_RADIO_OFF_OR_NOT_AVAILABLE"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/PhoneBase;->mOppoMmiRadioOffRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/internal/telephony/gsm/SIMRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    const-string v20, "[EONS] Populated EONS for available networks."
    ...
    invoke-static {v15, v7, v0}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string v20, "[EONS] In EVENT_GET_NETWORKS_DONE, onComplete is null!"
    ...
    const-string v20, "OPPO failed to EVENT_EM_DIAL_DONE."
    ...
    const-string v20, "OPPO succeed to EVENT_EM_DIAL_DONE."
    ...
    const-string v20, "OPPO receive EVENT_EM_CALL_STATUS_CHANGED."
    ...
    const-string v20, "OPPO failed to EVENT_EM_GET_CURRENT_CALLS_DONE."
    ...
    const-string v20, "OPPO failed to EVENT_EM_HANGUP_DONE."
    ...
    const-string v20, "OPPO succeed to EVENT_EM_HANGUP_DONE."
    ...
    const-string v20, "OPPO failed to EVENT_SEND_UPLINK_DATA_DONE."
    ...
    const-string v20, "Success to EVENT_SEND_UPLINK_DATA_DONE."
...
.method public is_test_card()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/SIMRecords;->is_test_card()Z
...
.method public is_usimcard()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/UiccCardApplication;->is_usimcard()Z
...
.method public setFacilityLock(Ljava/lang/String;ZLjava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "setFacilityLock()"
...
.method public updateCFAferLangChange()V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->updateCallForwardStatus(I)V
