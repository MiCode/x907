...
.field private static final EVENT_RADIO_POWER_COMPLETED:I = 0xa
...
.field private static mSetPowerRetry:I
...
.field private mPowerOprationBusy:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/PhoneProxy;->mSetPowerRetry:I
...
.method public constructor <init>(Lcom/android/internal/telephony/Phone;)V
    ...
    .line 69
    iput v3, p0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneSubscription:I

    .line 77
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneProxy;->mPowerOprationBusy:Z
    ...
    invoke-direct {v4, v1}, Lcom/android/internal/telephony/IccSmsInterfaceManager;-><init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-interface {v1, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForOn(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/internal/telephony/IccCardProxy;->setPhoneType(I)V
    ...
    .line 113
    const-string/jumbo v1, "xxx,setPowerStateToDesired first"
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mRegistry:Lcom/android/internal/telephony/ITelephonyRegistry;
...
.method private declared-synchronized setPowerStateToDesired()V
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mPowerOprationBusy:Z
    :try_end_0
    ...
    iget-boolean v5, p0, Lcom/android/internal/telephony/PhoneProxy;->mDesiredPowerState:Z

    invoke-static {v5}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v5

    invoke-virtual {p0, v4, v5}, Lcom/android/internal/telephony/PhoneProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mPowerOprationBusy:Z
    ...
    .line 725
    const-string/jumbo v2, "setPowerStateToDesired: DDS case: disconnect data"
    ...
    :cond_3
    :try_start_2
    const-string/jumbo v2, "setPowerStateToDesired: non-DDS case: send message to self"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 135
    .local v0, PowerState:Z
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "EVENT_RADIO_POWER_COMPLETED : set State to "
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/PhoneProxy;->logv(Ljava/lang/String;)V

    .line 136
    iput-boolean v6, p0, Lcom/android/internal/telephony/PhoneProxy;->mPowerOprationBusy:Z

    .line 137
    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mDesiredPowerState:Z
    ...
    const-string v5, " EVENT_RADIO_POWER_COMPLETED GENERIC_FAILURE===========wjp"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 147
    sget v4, Lcom/android/internal/telephony/PhoneProxy;->mSetPowerRetry:I
    ...
    const-string v5, "EVENT_RADIO_POWER_COMPLETED, we retry  three times but still fail"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 150
    sput v6, Lcom/android/internal/telephony/PhoneProxy;->mSetPowerRetry:I
    ...
    const-string v6, "EVENT_RADIO_POWER_COMPLETED  retry "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget v6, Lcom/android/internal/telephony/PhoneProxy;->mSetPowerRetry:I
    ...
    sput v4, Lcom/android/internal/telephony/PhoneProxy;->mSetPowerRetry:I
    ...
    .line 172
    .local v2, newPowerState:Z
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "EVENT_SET_RADIO_POWER : newPowerState = "
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/PhoneProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    invoke-interface {v4, v2, v5}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V

    goto/16 :goto_0

    .line 181
    .end local v2           #newPowerState:Z
    :pswitch_4
    iget-object v4, v1, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    const-string v5, "Voice Radio Technology event "
...
.method public is_usimcard()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->is_usimcard()Z
...
.method public oppoRegisterForSimPhonebookReady(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 1
    .parameter "h"
    .parameter "what"
    .parameter "obj"
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->oppoRegisterForSimPhonebookReady(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 1252
    return-void
.end method

.method public oppoRegisterForSimSmsReady(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 1
    .parameter "h"
    .parameter "what"
    .parameter "obj"
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->oppoRegisterForSimSmsReady(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 1259
    return-void
.end method

.method public oppoUnregisterForSimPhonebookReady(Landroid/os/Handler;)V
    .locals 1
    .parameter "h"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->oppoUnregisterForSimPhonebookReady(Landroid/os/Handler;)V

    .line 1255
    return-void
.end method

.method public oppoUnregisterForSimSmsReady(Landroid/os/Handler;)V
    .locals 1
    .parameter "h"
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->oppoUnregisterForSimSmsReady(Landroid/os/Handler;)V
...
.method public registerForNewSimChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerForNewSimChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public registerForOffOrNotAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerForOffOrNotAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public setRadioPower(Z)V
    ...
    const-string v2, "API call setRadioPower to "
    ...
    .line 646
    iget-boolean v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mPowerOprationBusy:Z
    ...
    .line 656
    .local v0, radiostate:Landroid/telephony/ServiceState;
    const/16 v1, 0x9

    invoke-virtual {v0, v1}, Landroid/telephony/ServiceState;->setState(I)V

    .line 657
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mRegistry:Lcom/android/internal/telephony/ITelephonyRegistry;
    ...
    .line 663
    .end local v0           #radiostate:Landroid/telephony/ServiceState;
    :cond_1
    :goto_1
    return-void
...
.method public unregisterForNewSimChanged(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterForNewSimChanged(Landroid/os/Handler;)V
...
.method public unregisterForOffOrNotAvailable(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterForOffOrNotAvailable(Landroid/os/Handler;)V
