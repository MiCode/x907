...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    iget-object v4, v4, Landroid/content/pm/ApplicationInfo;->manufacture:Ljava/lang/String;

    invoke-virtual {v2, v4}, Landroid/content/res/Resources;->setResourceManufacture(Ljava/lang/String;)Z
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    invoke-direct {v3, p1, v7}, Landroid/app/ActivityThread$ResourcesKey;-><init>(Ljava/lang/String;F)V
    ...
    invoke-static {v1, v4, v7, p2}, Landroid/content/res/MiuiClassFactory;->newResources(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    invoke-interface {v7, p1, v8}, Landroid/content/pm/IPackageManager;->getApplicationInfoForRes(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 1507
    iget-object v7, v0, Landroid/content/pm/ApplicationInfo;->manufacture:Ljava/lang/String;

    invoke-virtual {v5, v7}, Landroid/content/res/Resources;->setResourceManufacture(Ljava/lang/String;)Z
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual {p1, v7}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I
    ...
    const-string v9, "CONFIG_SKIN changed for oppo theme 3.0"
    ...
    const-string/jumbo v9, "reloadPreloadedResources for oppo theme 3.0"

    invoke-static {v7, v9}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 3613
    invoke-virtual {v5}, Landroid/content/res/Resources;->reloadPreloadedResources()V
...
.method public installSystemApplicationInfo(Landroid/content/pm/ApplicationInfo;)V
    ...
    .line 1724
    iget-object v0, p1, Landroid/content/pm/ApplicationInfo;->manufacture:Ljava/lang/String;

    invoke-virtual {v6, v0}, Landroid/content/res/Resources;->setResourceManufacture(Ljava/lang/String;)Z
