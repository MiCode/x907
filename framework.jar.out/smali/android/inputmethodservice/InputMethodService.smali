...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/inputmethodservice/InputMethodService$ImeWinMsgRunnable;,
...
.field private mImeWinMsgHandler:Landroid/os/Handler;
...
.field private final mInputMethodHideReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>()V
    ...
    .line 325
    iput-boolean v1, p0, Landroid/inputmethodservice/InputMethodService;->mbShowSoftinput:Z
    ...
    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mImeWinMsgHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mInputMethodHideReceiver:Landroid/content/BroadcastReceiver;
...
.method private sendImeWinHideBroadcast()V
    .locals 3

    .prologue
    .line 1594
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mImeWinMsgHandler:Landroid/os/Handler;

    new-instance v1, Landroid/inputmethodservice/InputMethodService$ImeWinMsgRunnable;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Landroid/inputmethodservice/InputMethodService$ImeWinMsgRunnable;-><init>(Landroid/inputmethodservice/InputMethodService;Z)V
...
.method private sendImeWinShowBroadcast()V
    .locals 3
...
.method public getExtractActionButton()Landroid/widget/Button;
    .locals 1
...
.method public getExtractEditText()Landroid/widget/EditText;
    .locals 1
...
.method public hideWindow()V
    ...
    .line 1562
    :cond_0
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->sendImeWinHideBroadcast()V

    .line 1563
    iput-boolean v3, p0, Landroid/inputmethodservice/InputMethodService;->mbShowSoftinput:Z
...
.method initViews()V
    ...
    const-string v2, "initViews mCandidatesVisibility = "
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 770
    .local v1, hidePreviousInitViews:Z
    if-eqz v5, :cond_0
    ...
    const-string v8, "hide ime before initViews"
...
.method public onCreate()V
    ...
    const-string v1, "action_oppo_hide_inputmethod"

    invoke-virtual {v0, v1}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 659
    iget-object v1, p0, Landroid/inputmethodservice/InputMethodService;->mInputMethodHideReceiver:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    .line 727
    iget-boolean v0, p0, Landroid/inputmethodservice/InputMethodService;->mbShowSoftinput:Z

    if-eqz v0, :cond_0

    .line 728
    iput-boolean v2, p0, Landroid/inputmethodservice/InputMethodService;->mbShowSoftinput:Z
    ...
    .line 741
    :cond_1
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mInputMethodHideReceiver:Landroid/content/BroadcastReceiver;
...
.method public onExtractTextIndicateMenuItem(I)Z
    .locals 2
    .parameter "id"
...
.method public showWindow(Z)V
    ...
    .line 1449
    :cond_0
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->sendImeWinShowBroadcast()V
...
.method showWindowInner(Z)V
    ...
    .line 1489
    const-string v5, "command_showing_input_window"

    const/4 v6, 0x0

    invoke-interface {v2, v5, v6}, Landroid/view/inputmethod/InputConnection;->performPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v5, v6, v8, v7}, Landroid/view/inputmethod/InputMethodManager;->setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    const-string/jumbo v7, "oppo wz add for ime BadTokenException"
...
.method startExtractingText(Z)V
    ...
    .line 2333
    iput v2, v5, Landroid/view/inputmethod/ExtractedTextRequest;->flags:I
    ...
    const-string v9, "Unexpected null in startExtractingText : mExtractedText = "
    ...
    const-string v9, ", input connection = "
    ...
    .line 2356
    :cond_2
    invoke-virtual {v0, v4}, Landroid/inputmethodservice/ExtractEditText;->setInputType(I)V
    ...
    .line 2359
    iget-object v6, v1, Landroid/view/inputmethod/EditorInfo;->privateImeOptions:Ljava/lang/String;

    if-eqz v6, :cond_6

    .line 2360
    .local v2, hasImePrivateOptions:Z
    :goto_1
    if-eqz v2, :cond_3
    ...
    invoke-virtual {v0, v6}, Landroid/inputmethodservice/ExtractEditText;->setPrivateImeOptions(Ljava/lang/String;)V
    ...
    .end local v2           #hasImePrivateOptions:Z
    ...
    :cond_5
    invoke-interface {v3, v5, v2}, Landroid/view/inputmethod/InputConnection;->getExtractedText(Landroid/view/inputmethod/ExtractedTextRequest;I)Landroid/view/inputmethod/ExtractedText;
    ...
    .line 2368
    .restart local v2       #hasImePrivateOptions:Z
    :cond_7
    const/4 v6, 0x0
