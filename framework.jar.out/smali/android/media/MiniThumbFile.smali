...
.field private static final INTERNAL_SD_PATH:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/MiniThumbFile;->INTERNAL_SD_PATH:Ljava/lang/String;
...
.method public static declared-synchronized instance(Landroid/net/Uri;)Landroid/media/MiniThumbFile;
    ...
    .prologue
    .line 75
    const-class v5, Landroid/media/MiniThumbFile;
    ...
    sget-object v4, Landroid/media/MiniThumbFile;->sThumbFiles:Ljava/util/Hashtable;

    invoke-virtual {v4, v3}, Ljava/util/Hashtable;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/media/MiniThumbFile;

    .line 80
    .local v1, file:Landroid/media/MiniThumbFile;
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    sget-object v6, Landroid/media/MiniThumbFile;->INTERNAL_SD_PATH:Ljava/lang/String;

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v6, "/DCIM/.thumbnails3--1967290299"
    ...
    .line 86
    new-instance v1, Landroid/media/MiniThumbFile;

    .end local v1           #file:Landroid/media/MiniThumbFile;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    invoke-direct {v1, v4}, Landroid/media/MiniThumbFile;-><init>(Landroid/net/Uri;)V

    .line 88
    .restart local v1       #file:Landroid/media/MiniThumbFile;
    sget-object v4, Landroid/media/MiniThumbFile;->sThumbFiles:Ljava/util/Hashtable;
