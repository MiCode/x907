...
# instance fields
.field private mManufactureId:I
...
.method private final native decryptFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;)I
.end method

.method private final native decryptStringNativeInOppoEncryption([B)[B
.end method

.method private final native decryptThemeFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
.end method
...
.method private final native encryptFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;)I
.end method

.method private final native encryptStringNativeInOppoEncryption([B)[B
.end method
...
.method private final native openXmlAssetNativeInOppoEncryption(ILjava/lang/String;)I
.end method
...
.method private final native updateManufacture(I)V
.end method
...
.method public final decryptFileInOppoEncryption(Ljava/io/File;Ljava/io/File;)I
    ...
    invoke-direct {p0, v0, v1}, Landroid/content/res/AssetManager;->decryptFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;)I
...
.method public final decryptStringInOppoEncryption([B)[B
    ...
    :cond_1
    invoke-direct {p0, p1}, Landroid/content/res/AssetManager;->decryptStringNativeInOppoEncryption([B)[B
...
.method public final decryptThemeFileInOppoEncryption(Ljava/io/File;Ljava/io/File;Ljava/io/File;)I
    ...
    invoke-direct {p0, v0, v1, v2}, Landroid/content/res/AssetManager;->decryptThemeFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
...
.method public final encryptFileInOppoEncryption(Ljava/io/File;Ljava/io/File;)I
    ...
    invoke-direct {p0, v0, v1}, Landroid/content/res/AssetManager;->encryptFileNativeInOppoEncryption(Ljava/lang/String;Ljava/lang/String;)I
...
.method public final encryptStringInOppoEncryption([B)[B
    ...
    :cond_1
    invoke-direct {p0, p1}, Landroid/content/res/AssetManager;->encryptStringNativeInOppoEncryption([B)[B
...
.method final getManufacture()I
    .locals 1

    .prologue
    .line 898
    iget v0, p0, Landroid/content/res/AssetManager;->mManufactureId:I
...
.method final openXmlBlockAssetInOppoEncryption(ILjava/lang/String;)Landroid/content/res/XmlBlock;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1, p2}, Landroid/content/res/AssetManager;->openXmlAssetNativeInOppoEncryption(ILjava/lang/String;)I
    ...
    .line 488
    .restart local v0       #res:Landroid/content/res/XmlBlock;
    invoke-virtual {v0}, Ljava/lang/Object;->hashCode()I
...
.method final openXmlBlockAssetInOppoEncryption(Ljava/lang/String;)Landroid/content/res/XmlBlock;
    .locals 1
    .parameter "fileName"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p0, v0, p1}, Landroid/content/res/AssetManager;->openXmlBlockAssetInOppoEncryption(ILjava/lang/String;)Landroid/content/res/XmlBlock;
...
.method final setManufacture(I)Z
    .locals 1
    .parameter "id"
    ...
    .line 890
    iput p1, p0, Landroid/content/res/AssetManager;->mManufactureId:I

    .line 891
    invoke-direct {p0, p1}, Landroid/content/res/AssetManager;->updateManufacture(I)V
