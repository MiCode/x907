...
.field private static final DEBUG_THEME:Z = true
...
.field private static final INSIST_MANUFACTURE_PRELOAD:Z = false

.field private static final STR_COLOR:Ljava/lang/String; = "color"

.field private static final STR_TYPE_THEME_LOCKSCREEN:Ljava/lang/String; = "ic_launcher_mainmenu_default_bg"

.field private static final STR_TYPE_THEME_PREVIEW:Ljava/lang/String; = "ic_default_theme"

.field private static final STR_TYPE_THEME_WALLPAPER:Ljava/lang/String; = "default_wallpaper"
...
.field private static final mPreloadedManufactureColorStateLists:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private static final sPreloadedManufactureColorDrawables:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private static final sPreloadedManufactureDrawables:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/content/res/Resources;->sPreloadedManufactureDrawables:Ljava/util/HashMap;
    ...
    sput-object v0, Landroid/content/res/Resources;->mPreloadedManufactureColorStateLists:Ljava/util/HashMap;
    ...
    sput-object v0, Landroid/content/res/Resources;->sPreloadedManufactureColorDrawables:Ljava/util/HashMap;
...
.method private getPreloadedColorStateList(II)Landroid/content/res/ColorStateList;
    .locals 4
    .parameter "key"
    ...
    .line 2277
    sget-object v2, Landroid/content/res/Resources;->mPreloadedManufactureColorStateLists:Ljava/util/HashMap;
    ...
    .line 2279
    .local v1, preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    if-eqz v1, :cond_1
    ...
    .line 2286
    .end local v1           #preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    :cond_0
    :goto_1
    return-object v0
    ...
    .restart local v1       #preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    :cond_1
    const/4 v0, 0x0
...
.method private getPreloadedDrawable(JIZ)Landroid/graphics/drawable/Drawable$ConstantState;
    .locals 4
    .parameter "key"
    .parameter "manufacture"
    ...
    sget-object v2, Landroid/content/res/Resources;->sPreloadedManufactureColorDrawables:Ljava/util/HashMap;
    ...
    .line 2248
    .local v1, preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    :goto_0
    if-eqz v1, :cond_2
    ...
    .line 2255
    .end local v1           #preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    :cond_0
    :goto_2
    return-object v0
    ...
    :cond_1
    sget-object v2, Landroid/content/res/Resources;->sPreloadedManufactureDrawables:Ljava/util/HashMap;
    ...
    .line 2248
    .restart local v1       #preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    :cond_2
    const/4 v0, 0x0
...
.method private setPreloadedColorStateList(Landroid/content/res/ColorStateList;II)V
    .locals 3
    .parameter "csl"
    .parameter "key"
    .parameter "manufacture"
    ...
    .line 2291
    sget-object v1, Landroid/content/res/Resources;->mPreloadedManufactureColorStateLists:Ljava/util/HashMap;
    ...
    .line 2293
    .local v0, preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    if-nez v0, :cond_0

    .line 2294
    new-instance v0, Landroid/util/SparseArray;

    .end local v0           #preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    .line 2295
    .restart local v0       #preloaded:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Landroid/content/res/ColorStateList;>;"
    sget-object v1, Landroid/content/res/Resources;->mPreloadedManufactureColorStateLists:Ljava/util/HashMap;
...
.method private setPreloadedDrawable(Landroid/graphics/drawable/Drawable$ConstantState;JIZ)V
    .locals 3
    .parameter "cs"
    .parameter "key"
    .parameter "manufacture"
    ...
    sget-object v1, Landroid/content/res/Resources;->sPreloadedManufactureColorDrawables:Ljava/util/HashMap;

    .line 2262
    .local v1, preloadedMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    :goto_0
    ...
    .line 2263
    .local v0, preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    if-nez v0, :cond_0

    .line 2264
    new-instance v0, Landroid/util/LongSparseArray;

    .end local v0           #preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    invoke-direct {v0}, Landroid/util/LongSparseArray;-><init>()V

    .line 2265
    .restart local v0       #preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    invoke-static {p4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
    ...
    .line 2272
    .end local v0           #preloaded:Landroid/util/LongSparseArray;,"Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;"
    .end local v1           #preloadedMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Landroid/util/LongSparseArray<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    :goto_1
    return-void

    .line 2260
    :cond_1
    sget-object v1, Landroid/content/res/Resources;->sPreloadedManufactureDrawables:Ljava/util/HashMap;
    ...
    invoke-virtual {v2, p2, p3, p1}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V
...
.method public getThemeImage(Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    const-string v7, "getThemeImage: itemType = "
    ...
    const-string v7, ",themePackagePath = "
    ...
    const-string v7, "getThemeImage themeDrawablePath = "
...
.method public getThemeLockScreen(Ljava/lang/String;)Landroid/graphics/Bitmap;
    .locals 1
    .parameter "pkgPath"

    .prologue
    .line 2376
    const-string v0, "ic_launcher_mainmenu_default_bg"
...
.method public getThemePreview(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 2366
    const-string v0, "ic_default_theme"
...
.method public getThemeWallpaper(Ljava/lang/String;)Landroid/graphics/Bitmap;
    .locals 1
    .parameter "pkgPath"
...
.method loadColorStateList(Landroid/util/TypedValue;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8}, Landroid/content/res/AssetManager;->getManufacture()I
    ...
    .line 2031
    invoke-direct {p0, v4, v5}, Landroid/content/res/Resources;->getPreloadedColorStateList(II)Landroid/content/res/ColorStateList;
    ...
    .line 2038
    invoke-direct {p0, v0, v4, v5}, Landroid/content/res/Resources;->setPreloadedColorStateList(Landroid/content/res/ColorStateList;II)V
...
.method loadDrawable(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2}, Landroid/content/res/AssetManager;->getManufacture()I
    ...
    invoke-direct {v0, v4, v5, v6, v13}, Landroid/content/res/Resources;->getPreloadedDrawable(JIZ)Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-virtual {v8, v2}, Landroid/graphics/drawable/Drawable;->setChangingConfigurations(I)V
    ...
    invoke-direct/range {v2 .. v7}, Landroid/content/res/Resources;->setPreloadedDrawable(Landroid/graphics/drawable/Drawable$ConstantState;JIZ)V
    ...
    invoke-direct {v2, v7}, Landroid/content/res/Resources$NotFoundException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v11, v1, v2, v7}, Landroid/content/res/Resources;->loadXmlResourceParser(Ljava/lang/String;IILjava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    invoke-virtual {v14, v10}, Landroid/content/res/Resources$NotFoundException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-virtual {v2, v7, v11, v0}, Landroid/content/res/AssetManager;->openNonAsset(ILjava/lang/String;I)Ljava/io/InputStream;
    ...
    iget-object v7, v0, Landroid/content/res/Resources;->mTmpValue:Landroid/util/TypedValue;
...
.method public final preparePreloadingManufacture()Z
    .locals 3
    ...
    invoke-virtual {v1}, Landroid/content/res/AssetManager;->getManufacture()I
...
.method public reloadPreloadedResources()V
    ...
    .line 2478
    sget-object v0, Landroid/content/res/Resources;->sPreloadedManufactureDrawables:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 2479
    sget-object v0, Landroid/content/res/Resources;->mPreloadedManufactureColorStateLists:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 2480
    sget-object v0, Landroid/content/res/Resources;->sPreloadedManufactureColorDrawables:Ljava/util/HashMap;
...
.method public setResourceManufacture(Ljava/lang/String;)Z
    .locals 2
    .parameter "manufacture"
    ...
    invoke-static {}, Landroid/content/res/ManufactureParser;->instance()Landroid/content/res/ManufactureParser;

    move-result-object v1

    invoke-virtual {v1, p1}, Landroid/content/res/ManufactureParser;->obtainId(Ljava/lang/String;)I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/content/res/AssetManager;->setManufacture(I)Z
