...
.field private static MIDDLE_SCALE_DODOUBLE:F = 0.0f
...
.field private mSuitableScale:F
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/webkit/ZoomManager;->MIDDLE_SCALE_DODOUBLE:F
...
.method public constructor <init>(Landroid/webkit/WebView;Landroid/webkit/CallbackProxy;)V
    ...
    .line 806
    iput-boolean v1, p0, Landroid/webkit/ZoomManager;->mDoCssZoom:Z

    .line 807
    iget v0, p0, Landroid/webkit/ZoomManager;->mDefaultScale:F

    iput v0, p0, Landroid/webkit/ZoomManager;->mSuitableScale:F
...
.method static synthetic access$1702(Landroid/webkit/ZoomManager;Z)Z
    ...
    .prologue
    .line 49
    iput-boolean p1, p0, Landroid/webkit/ZoomManager;->mDoCssZoom:Z
...
.method private getCssDoubleTapInfo(IILandroid/graphics/Rect;)F
    .locals 20
    .parameter "centerX"
    .parameter "centerY"
    .parameter "divBounds"
    ...
    iget v11, v0, Landroid/webkit/ZoomManager;->mSuitableScale:F

    .line 680
    .local v11, retScale:F
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/webkit/WebView;->getViewWidth()I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/webkit/WebView;->getViewHeightWithTitle()I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/webkit/WebView;->getScrollX()I

    move-result v14

    .line 683
    .local v14, viewScrollX:I
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/webkit/WebView;->getScrollY()I

    move-result v15

    .line 684
    .local v15, viewScrollY:I
    ...
    .line 687
    .local v6, divBounds_leftRange:I
    add-int v17, v14, v16
    ...
    .line 688
    .local v7, divBounds_rightRange:I
    move-object/from16 v0, p3
    ...
    .line 690
    .local v5, divBounds_bottomRange:I
    move/from16 v0, p1
    ...
    iput v0, v1, Landroid/webkit/ZoomManager;->mZoomCenterX:F
    ...
    iput v0, v1, Landroid/webkit/ZoomManager;->mZoomCenterY:F
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/webkit/ZoomManager;->resetCenterValueNotByDiv(FFZ)V

    move v12, v11

    .line 705
    .end local v11           #retScale:F
    .local v12, retScale:F
    :goto_0
    return v12

    .line 699
    .end local v12           #retScale:F
    .restart local v11       #retScale:F
    :cond_1
    move/from16 v0, v16
    ...
    invoke-direct {v0, v14, v1, v11}, Landroid/webkit/ZoomManager;->pinZoomCenterValues(IIF)I
...
.method private getDivBounds(II)Landroid/graphics/Rect;
    .locals 8
    .parameter "viewX"
    .parameter "viewY"
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/webkit/WebView;->nativeGetDivNodeBounds(IIIIF)Landroid/graphics/Rect;

    move-result-object v6

    .line 666
    .local v6, divBounds:Landroid/graphics/Rect;
    if-eqz v6, :cond_0
    ...
    invoke-virtual {v5, v7}, Landroid/webkit/WebView;->contentToViewY(I)I
...
.method private handleAndroidDoubleTap(FF)V
    .locals 8
...
.method private pinZoomCenterValues(IIF)I
    .locals 4
    .parameter "oldScrollValue"
    .parameter "targetScrollValue"
...
.method private resetCenterValueNotByDiv(FFZ)V
    .locals 10
    .parameter "centerX"
    .parameter "centerY"
    .parameter "zoomOut"
    ...
    invoke-virtual {v7}, Landroid/webkit/WebView;->getViewHeight()I
    ...
    .line 722
    iput v9, p0, Landroid/webkit/ZoomManager;->mZoomCenterY:F
    ...
    iget v7, p0, Landroid/webkit/ZoomManager;->mZoomCenterX:F
    ...
    iget v7, p0, Landroid/webkit/ZoomManager;->mZoomCenterY:F

    sub-float/2addr v7, v8

    :goto_1
    iput v7, p0, Landroid/webkit/ZoomManager;->mZoomCenterY:F
...
.method private startZoomAnimation(FZZ)Z
    .locals 6
    .parameter "scale"
    .parameter "reflowText"
    .parameter "force"
    ...
    .line 471
    :cond_2
    iput-boolean v2, p0, Landroid/webkit/ZoomManager;->mInHWAcceleratedZoom:Z
...
.method public handleDoubleTap(FF)V
    ...
    sget v4, Landroid/webkit/ZoomManager;->MIDDLE_SCALE_DODOUBLE:F

    invoke-static {v3, v4}, Ljava/lang/Math;->min(FF)F

    move-result v3

    iput v3, p0, Landroid/webkit/ZoomManager;->mSuitableScale:F
    ...
    sget v4, Landroid/webkit/ZoomManager;->MINIMUM_SCALE_INCREMENT:F

    cmpg-float v3, v3, v4

    if-lez v3, :cond_2

    iget-boolean v3, p0, Landroid/webkit/ZoomManager;->mDoCssZoom:Z
    ...
    invoke-direct {p0, v3, v4}, Landroid/webkit/ZoomManager;->getDivBounds(II)Landroid/graphics/Rect;

    move-result-object v0

    .line 828
    .local v0, divBounds:Landroid/graphics/Rect;
    float-to-int v3, p1

    float-to-int v4, p2

    invoke-direct {p0, v3, v4, v0}, Landroid/webkit/ZoomManager;->getCssDoubleTapInfo(IILandroid/graphics/Rect;)F

    move-result v1

    .line 830
    iput-boolean v6, p0, Landroid/webkit/ZoomManager;->mDoCssZoom:Z

    .line 840
    .end local v0           #divBounds:Landroid/graphics/Rect;
    :goto_1
    iget-object v3, p0, Landroid/webkit/ZoomManager;->mWebView:Landroid/webkit/WebView;
    ...
    .line 842
    invoke-virtual {v2, v7}, Landroid/webkit/WebSettings;->setDoubleTapToastCount(I)V
    ...
    .line 850
    invoke-virtual {p0, v1, v7}, Landroid/webkit/ZoomManager;->startZoomAnimation(FZ)Z

    goto :goto_0

    .line 832
    :cond_3
    iput-boolean v7, p0, Landroid/webkit/ZoomManager;->mDoCssZoom:Z
    ...
    .line 852
    :cond_4
    invoke-direct {p0, v1, v6, v6}, Landroid/webkit/ZoomManager;->startZoomAnimation(FZZ)Z

    goto :goto_0

    .line 855
    :cond_5
    invoke-direct {p0, p1, p2}, Landroid/webkit/ZoomManager;->handleAndroidDoubleTap(FF)V
...
.method public updateMultiTouchSupport(Landroid/content/Context;)V
    ...
    invoke-direct {v3, p0, v6}, Landroid/webkit/ZoomManager$ScaleDetectorListener;-><init>(Landroid/webkit/ZoomManager;Landroid/webkit/ZoomManager$1;)V
