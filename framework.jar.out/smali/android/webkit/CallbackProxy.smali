...
.field private static final BLANK_SHORT_PRESS:I = 0x93
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 272
    .local v68, startedUrl:Ljava/lang/String;
    ...
    .line 279
    .end local v68           #startedUrl:Ljava/lang/String;
    :pswitch_2
    move-object/from16 v0, p1
    ...
    check-cast v63, Landroid/os/Message;

    .line 319
    .local v63, resend:Landroid/os/Message;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .end local v63           #resend:Landroid/os/Message;
    :pswitch_8
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    check-cast v64, Landroid/webkit/CallbackProxy$ResultTransport;

    .line 334
    .local v64, result:Landroid/webkit/CallbackProxy$ResultTransport;,"Landroid/webkit/CallbackProxy$ResultTransport<Ljava/lang/Boolean;>;"
    monitor-enter p0
    ...
    .end local v64           #result:Landroid/webkit/CallbackProxy$ResultTransport;,"Landroid/webkit/CallbackProxy$ResultTransport<Ljava/lang/Boolean;>;"
    :pswitch_9
    move-object/from16 v0, p0
    ...
    .line 345
    .local v61, realm:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v61           #realm:Ljava/lang/String;
    :pswitch_a
    move-object/from16 v0, p0
    ...
    .line 445
    .local v65, schemePlusHost:Ljava/lang/String;
    ...
    .end local v65           #schemePlusHost:Ljava/lang/String;
    ...
    check-cast v34, Landroid/webkit/GeolocationPermissions$Callback;

    .line 510
    .local v34, callback:Landroid/webkit/GeolocationPermissions$Callback;
    move-object/from16 v0, p0
    ...
    .line 516
    .end local v34           #callback:Landroid/webkit/GeolocationPermissions$Callback;
    .end local v52           #map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    ...
    check-cast v43, Ljava/util/Vector;

    .line 526
    .local v43, features:Ljava/util/Vector;,"Ljava/util/Vector<Ljava/lang/String;>;"
    ...
    .line 533
    .restart local v34       #callback:Landroid/webkit/GeolocationPermissions$Callback;
    const/16 v54, 0x0

    .line 535
    .local v54, methodFound:Z
    :try_start_5
    move-object/from16 v0, p0
    ...
    .end local v35           #cls:Ljava/lang/Class;
    .end local v47           #i:I
    .end local v51           #m:[Ljava/lang/reflect/Method;
    :catch_0
    move-exception v40
    ...
    .restart local v35       #cls:Ljava/lang/Class;
    .restart local v47       #i:I
    .restart local v51       #m:[Ljava/lang/reflect/Method;
    :cond_9
    ...
    .end local v34           #callback:Landroid/webkit/GeolocationPermissions$Callback;
    .end local v35           #cls:Ljava/lang/Class;
    .end local v43           #features:Ljava/util/Vector;,"Ljava/util/Vector<Ljava/lang/String;>;"
    .end local v47           #i:I
    .end local v51           #m:[Ljava/lang/reflect/Method;
    .end local v52           #map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    .end local v54           #methodFound:Z
    :pswitch_1b
    move-object/from16 v0, p0
    ...
    .line 562
    .restart local v54       #methodFound:Z
    :try_start_6
    move-object/from16 v0, p0
    ...
    .line 613
    .local v32, bte:Landroid/view/WindowManager$BadTokenException;
    invoke-virtual/range {v27 .. v27}, Landroid/webkit/JsResult;->setReady()V
    ...
    .end local v32           #bte:Landroid/view/WindowManager$BadTokenException;
    :pswitch_1d
    move-object/from16 v0, p0
    ...
    invoke-virtual {v4}, Landroid/app/AlertDialog$Builder;->show()Landroid/app/AlertDialog;
    :try_end_8
    .catch Landroid/view/WindowManager$BadTokenException; {:try_start_8 .. :try_end_8} :catch_3
    ...
    .line 665
    .restart local v32       #bte:Landroid/view/WindowManager$BadTokenException;
    invoke-virtual/range {v27 .. v27}, Landroid/webkit/JsResult;->setReady()V
    ...
    .line 727
    .restart local v41       #factory:Landroid/view/LayoutInflater;
    .restart local v73       #v:Landroid/widget/EditText;
    .restart local v74       #view:Landroid/view/View;
    :catch_4
    move-exception v32
    ...
    invoke-virtual {v4}, Landroid/app/AlertDialog$Builder;->show()Landroid/app/AlertDialog;
    :try_end_a
    .catch Landroid/view/WindowManager$BadTokenException; {:try_start_a .. :try_end_a} :catch_5
    ...
    .line 774
    .restart local v51       #m:Ljava/lang/String;
    :catch_5
    move-exception v32
    ...
    .line 824
    .local v67, sourceID:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .end local v55           #msgLevel:I
    .end local v56           #numberOfMessageLevels:I
    .end local v67           #sourceID:Ljava/lang/String;
    :pswitch_2b
    move-object/from16 v0, p0
    ...
    .line 892
    .restart local v61       #realm:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    check-cast v66, Landroid/webkit/SearchBoxImpl;

    .line 907
    .local v66, searchBox:Landroid/webkit/SearchBoxImpl;
    move-object/from16 v0, p1
    ...
    .line 908
    .local v70, suggestions:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 912
    .end local v66           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v70           #suggestions:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :pswitch_32
    move-object/from16 v0, p0
    ...
    .line 923
    .restart local v66       #searchBox:Landroid/webkit/SearchBoxImpl;
    move-object/from16 v0, p1
    ...
    .line 924
    .local v71, supported:Ljava/lang/Boolean;
    ...
    .line 928
    .end local v66           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v71           #supported:Ljava/lang/Boolean;
    :pswitch_34
    move-object/from16 v0, p0
    ...
    .line 930
    .local v69, success:Ljava/lang/Boolean;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Message;->getData()Landroid/os/Bundle;
    ...
    .line 935
    .end local v66           #searchBox:Landroid/webkit/SearchBoxImpl;
    .end local v69           #success:Ljava/lang/Boolean;
    :pswitch_35
    move-object/from16 v0, p0
    ...
    invoke-virtual {v4, v9}, Landroid/webkit/WebViewClient;->onBlankShortPress(Landroid/webkit/WebView;)V
...
.method public onBlankShortPress()V
    .locals 2
