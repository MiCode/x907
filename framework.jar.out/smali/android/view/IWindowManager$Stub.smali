...
.field static final TRANSACTION_DisablePowerKey:I = 0x49

.field static final TRANSACTION_addAppToken:I = 0x15

.field static final TRANSACTION_addWindowToken:I = 0x13

.field static final TRANSACTION_apkplaySounds:I = 0x61
...
.field static final TRANSACTION_getWindowAnimating:I = 0x55

.field static final TRANSACTION_getWindowPositionOnScreen:I = 0x56
...
.field static final TRANSACTION_isAtEngineerMode:I = 0x66

.field static final TRANSACTION_isKeyguardLocked:I = 0x2c

.field static final TRANSACTION_isKeyguardSecure:I = 0x2d

.field static final TRANSACTION_isLockWndShow:I = 0x62

.field static final TRANSACTION_isViewServerRunning:I = 0x3

.field static final TRANSACTION_keyguardGetBatteryLevel:I = 0x5b

.field static final TRANSACTION_keyguardGetBatteryStatus:I = 0x5c

.field static final TRANSACTION_keyguardGetDisplaySimState:I = 0x5d

.field static final TRANSACTION_keyguardGetMissCallDisplayInfo:I = 0x5a

.field static final TRANSACTION_keyguardGetTelephonyPlmn:I = 0x5e

.field static final TRANSACTION_keyguardGetTelephonySpn:I = 0x5f

.field static final TRANSACTION_keyguardGetUnreadSmsDisplayInfo:I = 0x59

.field static final TRANSACTION_keyguardSetApkLockScreenShowing:I = 0x60
...
.field static final TRANSACTION_pausePreprocessEvent:I = 0x67

.field static final TRANSACTION_pauseRotationLocked:I = 0x4d

.field static final TRANSACTION_pokeWakelock:I = 0x64

.field static final TRANSACTION_prepareAppTransition:I = 0x1a

.field static final TRANSACTION_reenableKeyguard:I = 0x2a

.field static final TRANSACTION_registerKeyguardCallbacks:I = 0x57
...
.field static final TRANSACTION_resumePreprocessEvent:I = 0x68

.field static final TRANSACTION_resumeRotationLocked:I = 0x4e
...
.field static final TRANSACTION_setDoAnimation:I = 0x63
...
.field static final TRANSACTION_setOrientationAnimEnabled:I = 0x54
...
.field static final TRANSACTION_stopResetTouchScreen:I = 0x65

.field static final TRANSACTION_stopViewServer:I = 0x2

.field static final TRANSACTION_thawRotation:I = 0x4c

.field static final TRANSACTION_unregisterKeyguardCallbacks:I = 0x58
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v2, _arg0:Z
    :goto_29
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->DisablePowerKey(Z)V
    ...
    .line 894
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->resumeRotationLocked()V
    ...
    .line 969
    .local v2, _arg0:Landroid/os/IBinder;
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->getWindowAnimating(Landroid/os/IBinder;)Z
    ...
    .line 979
    .restart local v2       #_arg0:Landroid/os/IBinder;
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->getWindowPositionOnScreen(Landroid/os/IBinder;)[I
    ...
    invoke-static {v1}, Landroid/view/IKeyguardCallBack$Stub;->asInterface(Landroid/os/IBinder;)Landroid/view/IKeyguardCallBack;

    move-result-object v2

    .line 989
    .local v2, _arg0:Landroid/view/IKeyguardCallBack;
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->registerKeyguardCallbacks(Landroid/view/IKeyguardCallBack;)V
    ...
    .line 995
    .end local v2           #_arg0:Landroid/view/IKeyguardCallBack;
    :sswitch_58
    const-string v1, "android.view.IWindowManager"
    ...
    .line 996
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->unregisterKeyguardCallbacks()V
    ...
    .line 1003
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetUnreadSmsDisplayInfo()Ljava/lang/String;
    ...
    .line 1011
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetMissCallDisplayInfo()Ljava/lang/String;
    ...
    .line 1019
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetBatteryLevel()I
    ...
    .line 1027
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetBatteryStatus()I
    ...
    .line 1035
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetDisplaySimState()I
    ...
    .line 1043
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetTelephonyPlmn()Ljava/lang/CharSequence;

    move-result-object v13

    .line 1044
    .local v13, _result:Ljava/lang/CharSequence;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    invoke-static {v13, v0, v1}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V
    ...
    .line 1056
    .end local v13           #_result:Ljava/lang/CharSequence;
    :sswitch_5f
    const-string v1, "android.view.IWindowManager"
    ...
    .line 1057
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->keyguardGetTelephonySpn()Ljava/lang/CharSequence;

    move-result-object v13

    .line 1058
    .restart local v13       #_result:Ljava/lang/CharSequence;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .local v2, _arg0:Z
    :goto_30
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->keyguardSetApkLockScreenShowing(Z)V
    ...
    .restart local v2       #_arg0:Z
    :goto_31
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->apkplaySounds(Z)V
    ...
    .restart local v2       #_arg0:Z
    :goto_33
    invoke-virtual {p0, v2}, Landroid/view/IWindowManager$Stub;->setDoAnimation(Z)V
    ...
    .line 1106
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->pokeWakelock()V
    ...
    .line 1113
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->stopResetTouchScreen()V
    ...
    .line 1120
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->isAtEngineerMode()Z
    ...
    .line 1128
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->pausePreprocessEvent()V
    ...
    .line 1135
    invoke-virtual {p0}, Landroid/view/IWindowManager$Stub;->resumePreprocessEvent()V
