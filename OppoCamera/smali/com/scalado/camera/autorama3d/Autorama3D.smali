...
.method private createPanoramaSession(Lcom/scalado/caps/autorama/Lens;Lcom/scalado/caps/autorama/Direction;Ljava/util/Vector;)[Lcom/scalado/caps/Session;
    ...
    new-array v3, v1, [Lcom/scalado/caps/Session;
    ...
    const-string v2, "No sources when rendering autorama. Returning null session"
    ...
    check-cast v0, Lcom/scalado/camera/autorama3d/Autorama3D$AutoramaImage;

    invoke-virtual {v0}, Lcom/scalado/camera/autorama3d/Autorama3D$AutoramaImage;->getDecoder()Lcom/scalado/caps/Decoder;
    ...
    const-string v2, "Cannot complete stitch due to Direction UNKNOWN. Returning null session"
    ...
    .line 564
    :cond_2
    new-instance v4, Lcom/scalado/caps/autorama/Stitcher;
    ...
    invoke-virtual {v0}, Lcom/scalado/camera/autorama3d/Autorama3D$AutoramaImage;->getDimensions()Lcom/scalado/base/Size;

    move-result-object v0

    invoke-direct {v4, p1, v0, p2}, Lcom/scalado/caps/autorama/Stitcher;-><init>(Lcom/scalado/caps/autorama/Lens;Lcom/scalado/base/Size;Lcom/scalado/caps/autorama/Direction;)V
    ...
    invoke-direct {v1, v6, v6}, Lcom/scalado/caps/autorama/Stitcher$BlendModeOptions;-><init>(ZZ)V

    invoke-virtual {v4, v0, v1}, Lcom/scalado/caps/autorama/Stitcher;->setBlendMode(Lcom/scalado/caps/autorama/Stitcher$BlendMode;Lcom/scalado/caps/autorama/Stitcher$BlendModeOptions;)V
    ...
    .line 581
    new-instance v0, Lcom/scalado/caps/autorama/stereo/StereoPanoramaFromMultiAngle;

    const/4 v1, 0x5

    const/4 v5, 0x4

    invoke-direct {v0, v4, v1, v2, v5}, Lcom/scalado/caps/autorama/stereo/StereoPanoramaFromMultiAngle;-><init>(Lcom/scalado/caps/autorama/Stitcher;III)V

    .line 582
    invoke-virtual {v0}, Lcom/scalado/caps/autorama/stereo/StereoPanorama;->render()V

    .line 584
    new-instance v1, Lcom/scalado/caps/Session;

    invoke-virtual {v0}, Lcom/scalado/caps/autorama/stereo/StereoPanorama;->getLeftDecoder()Lcom/scalado/caps/Decoder;

    move-result-object v4

    invoke-direct {v1, v4}, Lcom/scalado/caps/Session;-><init>(Lcom/scalado/caps/Decoder;)V
    ...
    invoke-virtual {v0}, Lcom/scalado/caps/autorama/stereo/StereoPanorama;->getRightDecoder()Lcom/scalado/caps/Decoder;
    ...
    invoke-virtual {v0, v4}, Lcom/scalado/camera/autorama3d/Autorama3D$AutoramaImage;->addToStitcher(Lcom/scalado/caps/autorama/Stitcher;)V
    :try_end_0
