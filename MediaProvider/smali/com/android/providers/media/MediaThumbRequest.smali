...
# static fields
.field static final ALL_IMAGE_URI:Landroid/net/Uri;

.field static final ALL_VIDEO_URI:Landroid/net/Uri;

.field private static final OPPOTHUMB_PROJECTION:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    .line 60
    const-string v0, "content://media/all/video/media"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Lcom/android/providers/media/MediaThumbRequest;->ALL_VIDEO_URI:Landroid/net/Uri;

    .line 61
    const-string v0, "content://media/all/images/media"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Lcom/android/providers/media/MediaThumbRequest;->ALL_IMAGE_URI:Landroid/net/Uri;
    ...
    const-string v1, "oppo_data"

    aput-object v1, v0, v2

    sput-object v0, Lcom/android/providers/media/MediaThumbRequest;->OPPOTHUMB_PROJECTION:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/providers/media/MediaThumbRequest;->mRandom:Ljava/util/Random;
...
.method constructor <init>(Landroid/content/ContentResolver;Ljava/lang/String;Landroid/net/Uri;IJ)V
    ...
    .line 111
    iget-object v1, p0, Lcom/android/providers/media/MediaThumbRequest;->mPath:Ljava/lang/String;
...
.method execute()V
    ...
    .line 321
    .local v17, oppoThumbFileName:Ljava/lang/String;
    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-virtual {v0, v8, v1}, Lcom/android/providers/media/MediaThumbRequest;->updateDatabase(Landroid/graphics/Bitmap;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 334
    .end local v17           #oppoThumbFileName:Ljava/lang/String;
    ...
    .restart local v6       #magic:J
    :cond_9
    sget-object v2, Lcom/android/providers/media/MediaThumbRequest;->mRandom:Ljava/util/Random;
...
.method updateDatabase(Landroid/graphics/Bitmap;Ljava/lang/String;)Landroid/net/Uri;
    .locals 11
    .parameter "thumbnail"
    .parameter "oppoFilename"
